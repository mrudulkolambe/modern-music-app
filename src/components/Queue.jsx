...
const Queue = ({setShowQueue}) => {
	...
	useEffect(() => {
		const data = getLocalStorage('queue')
		if (data) {
			setSongs(data)
			setResult(data)
			console.log(data)
	...
	return (
		<>
			<div className='px-10 pt-10 bg-black bg-opacity-5 backdrop-blur-2xl overflow-auto z-50 absolute top-0 left-[20vw] h-[84vh] w-[80vw]'>
